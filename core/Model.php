<?php
    ...
    abstract class Model {
        ...
        public function getProductPriceFromProductId(int $productId): array{
            $sql = 'SELECT amount FROM product_price WHERE product_id = ?;';
            $prep = $this->dbc->getConnection()->prepare($sql);
        ...
        public function getProductCharacteristicsFromProductId(int $productId): array{
            $sql = 'SELECT value FROM product_characteristic WHERE product_id = ?;';
            $prep = $this->dbc->getConnection()->prepare($sql);
            $res = $prep->execute([$productId]);
            $items = [];
            if ($res) {
        ...
        final public function addCategory(array $data){
